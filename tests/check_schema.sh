...
for col in "chain_of_custody:invoiced_at" "chain_of_custody:cancelled_at" "chain_of_custody:cancel_reason" "chain_of_custody:receiver_id" "chain_of_custody:received_by" "s29_supplies:raw_quantity"; do
